...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'team-member', 'administrator', 'end-user', 'guest-user'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Owners', path: '/owners', entity: 'owner', service: AccessServiceEnum.PROJECT, icon: FiHome },
