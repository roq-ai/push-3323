  ...
  const fetcher = useCallback(
    async () =>
      getTeamMembers({
        ...
        order: params.order,
        searchTermKeys: ['name.contains', 'position.contains', 'qualification.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'position', header: 'Position', accessorKey: 'position' },
    {
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.joined_date ? format(parseISO(record?.joined_date as unknown as string), 'dd-MM-yyyy') : '',
    },
