  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Push - Your High-Value Investment Opportunity. Leveraging Artificial Intelligence to Deliver Essential Administrative and Operational Services for Startups."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1534723328310-e82dad3ee43f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxhcnRpZmljaWFsJTIwaW50ZWxsaWdlbmNlfGVufDB8fHx8MTY5NjQ2MjA5OHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Push - Your High-Value Investment Opportunity. Leveraging Artificial Intelligence to Deliver Essential Administrative and Operational Services for Startups.`}
            </Text>
            <Box
