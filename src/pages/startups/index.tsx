  ...
  const fetcher = useCallback(
    async () =>
      getStartups({
        ...
        order: params.order,
        searchTermKeys: ['description.contains', 'industry.contains', 'location.contains', 'name.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    { id: 'description', header: 'Description', accessorKey: 'description' },
    {
      ...
      cell: ({ row: { original: record } }: any) =>
        record?.founded_date ? format(parseISO(record?.founded_date as unknown as string), 'dd-MM-yyyy') : '',
    },
